...
function bind(func, obj, ...args) {
    if (typeof func !== 'function') throw new Error('first parameter must be a function');
    if (typeof obj !== 'object' && !Array.isArray(obj)) throw new Error('second parameter must be an object');
