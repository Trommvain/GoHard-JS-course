...
function CleanerRobot(initialEnergy = 0 /* Изначальный заряд батареи */) {
    ...
    function setEnergy(value) {
        // Решение
        if (value < 0) throw new Error('New energy level can not be less than 0.');
        if (value > MAX_ENERGY_CAPACITY) throw new Error(`New energy level can not be more than ${MAX_ENERGY_CAPACITY}.`);
        this.energy  = value;
    }
}
